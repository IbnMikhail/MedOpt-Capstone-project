                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="absolute left-[30%] bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <p className="text-gray-600">
                      In recent times where patients often face challenges when
                      it comes to choosing the most suitable and cost-effective
                      medication options. We provide patients with medication
                      choices based on affordability and for better health
                      outcomes. At MedOpt, we are dedicated to helping you make
                      informed decisions about your healthcare. Our mission is
                      to provide you with affordable alternatives to expensive
                      medications, ensuring you receive the best possible care
                  ...
                  <div className="relative top-[100%] left-[5%] bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <p className="text-gray-600">
                      ...
                      their brand-name counterparts. You can save money without
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <div className="">
                  ...
                  <p className="mt-4">
                    I am an Educationist and IT Enthusiast with an intermediate
                    level of expertise in front end web development and Cyber
                    Security. I am an excellent team player and strive for both
                    individual and team success." I am a Passionate about
                    developing user-friendly and visually appealing websites.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="mt-4">
                  I am a developer who is proficient in using the MERN (MongoDB,
                  Express.js, React.js, and Node.js) technology stack for
                  developing web applications. I am able to handle both the
                  front-end and back-end development of web applications using
                  these technologies.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg">
                ...
                <p className="mt-4">
                  ...
                  creating user-friendly and visually appealing websites. My
                  skills include HTML, CSS, JavaScript, and responsive design.
